<div>
    <label class="form-control mx-2" wire:click="add"
        style="cursor: pointer; display: inline-block; padding: 8px 12px; background-color: #c8dbf0; color: rgb(0, 0, 0); border-radius: 4px;">
        <span wire:loading wire:target="add" class="spinner-border spinner-border-sm" role="status"
            aria-hidden="true"></span>
        <span class="ml-2">Nueva Imagen</span>
    </label>
